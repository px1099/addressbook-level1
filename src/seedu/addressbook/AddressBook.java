...
public class AddressBook {
    ...
    private static final String COMMAND_SORT_DESC = "Lists the persons in alphabetical order";
    ...
    private static String executeSortedListAllPersonsInAddressBook() {
        ...
        Collections.sort(toBeDisplayed, new Comparator<String[]>() {
            ...
            public int compare(String[] a, String[] b) {
                return (getNameFromPerson(a).toLowerCase()).compareTo(getNameFromPerson(b).toLowerCase());
            }
        });
        showToUser(toBeDisplayed);
        return getMessageForPersonsDisplayedSummary(toBeDisplayed);
